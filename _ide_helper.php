 ...
 * Generated for Laravel 5.2.45 on 2017-07-27.
 *
...
namespace Orchestra\Imagine { 
    ...
    class Facade {
        ...
        public static function getDefaultDriver()
        {
            return \Orchestra\Imagine\ImagineManager::getDefaultDriver();
        }
        ...
        public static function setDefaultDriver($name)
        {
            \Orchestra\Imagine\ImagineManager::setDefaultDriver($name);
        }
        ...
        {
            return \Orchestra\Imagine\ImagineManager::getConfig();
        }
        ...
        {
            return \Orchestra\Imagine\ImagineManager::setConfig($config);
        }
        ...
        {
            //Method inherited from \Illuminate\Support\Manager            
            return \Orchestra\Imagine\ImagineManager::driver($driver);
        }
        ...
        {
            //Method inherited from \Illuminate\Support\Manager            
            return \Orchestra\Imagine\ImagineManager::extend($driver, $callback);
        }
        ...
        {
            //Method inherited from \Illuminate\Support\Manager            
            return \Orchestra\Imagine\ImagineManager::getDrivers();
        }
...
namespace  { 
    ...
    class Imagine extends \Orchestra\Imagine\Facade {}
